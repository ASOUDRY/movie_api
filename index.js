...
//   });
  ...
  app.post('/:Username/Test/:Id', 
  // passport.authenticate('jwt', {session: false}), 
  (req, res) => {
    Users.findOneAndUpdate({ Username: req.params.Username }, {
       $push: { FavoriteMovies: {Title: req.params.Username, Test: req.params.Id}}
      },
     { new: true }, // This line makes sure that the updated document is returned
    (err, updatedUser) => {
      if (err) {
  ...
  app.post('/:Username/Test/:Id/Remove', 
  // passport.authenticate('jwt', {session: false}), 
  (req, res) => {
    Users.findOneAndUpdate({ Username: req.params.Username }, {
       $pull: { FavoriteMovies: {Title: req.params.Username, Test: req.params.Id}}
      },
     { new: true }, // This line makes sure that the updated document is returned
    (err, updatedUser) => {
      if (err) {
